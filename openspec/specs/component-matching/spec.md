...
Defines how module release components are matched against transformer definitions in a provider, and how unhandled traits are surfaced as warnings after matching.
