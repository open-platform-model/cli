...
Defines the contract for how `core.Module` exposes its fully-evaluated CUE value. The evaluated value is a first-class data item passed between pipeline phases, accessed directly as a public field rather than through accessor methods.
