# Module CUE Evaluation

## Purpose

Defines how `module.Load()` performs full CUE evaluation after AST inspection to produce a base `cue.Value` and populate all `core.Module` fields. This enables `Build()` to use the preloaded value directly, avoiding a second evaluation pass.
