...
Defines the contract for building a concrete `*core.ModuleRelease` from a loaded `*core.Module`. The builder is responsible for value selection, schema validation, CUE-native evaluation of metadata and labels, and concreteness verification. It is the BUILD phase of the OPM render pipeline.
