...
Consolidates domain-specific error types (`TransformError`, `ValidationError`) into `internal/errors/domain.go`, and organizes the `internal/errors` package into three files with clear, distinct responsibilities.
