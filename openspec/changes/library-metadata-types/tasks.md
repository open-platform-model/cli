...
- [ ] 1.3 `task fmt`, `task lint`, `task test` green, then commit `refactor(render): carry the library metadata types in Result`
...
- [ ] 2.2 `task fmt`, `task lint`, `task test` green, then commit `refactor(module): delete the pkg/module copy`
