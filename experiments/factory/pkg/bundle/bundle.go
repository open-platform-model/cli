...
type Bundle struct {
	...
	// #instances, #config, and #policies are accessible here for CUE-side
	// operations; Go does not decode them directly.
	Data cue.Value
}

// BundleMetadata holds identity metadata for a bundle.
// Mirrors #Bundle.metadata fields with json-decodable types.
// Structurally parallel to module.ModuleMetadata — same identity fields,
// same json tags.
type BundleMetadata struct {
	...
	// Example: "opmodel.dev/bundles/observability-stack:v1"
	FQN string `json:"fqn"`
