...
- Add a body (separated by blank line) only when the what/why isn't obvious from the subject.

## Message Content

Focus on **what** is being changed and committed. Be specific and descriptive but concise.
