...
func TestNewModuleEventsCmd_FlagsExist(t *testing.T) {
	cfg := &config.GlobalConfig{}
	cmd := NewModuleEventsCmd(cfg)
...
func TestNewModuleEventsCmd_FlagDefaults(t *testing.T) {
	cfg := &config.GlobalConfig{}
	cmd := NewModuleEventsCmd(cfg)
...
func TestNewModuleEventsCmd_OutputShorthand(t *testing.T) {
	cfg := &config.GlobalConfig{}
	cmd := NewModuleEventsCmd(cfg)
...
func TestRunEvents_ValidationErrors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := runModuleEvents(nil, cfg, &tt.rsf, kf, sinceFmt, tt.typeFlag, watchMode, outputFmt)
			require.Error(t, err)
...
func TestRunEventsWatch_ContextCancellation(t *testing.T) {
	...
	err := query.WatchEvents(ctx, client, opts, "test")
