...
func NewModuleDeleteCmd(cfg *config.GlobalConfig) *cobra.Command {
...
Examples:
  ...
  opm module delete --release-name my-app -n production

  # Delete release by release ID
  opm module delete --release-id a1b2c3d4-e5f6-7890-abcd-ef1234567890 -n production

  # Preview what would be deleted
  opm module delete --release-name my-app -n production --dry-run

  # Skip confirmation prompt
  opm module delete --release-name my-app -n production --force`,
