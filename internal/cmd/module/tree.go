...
// NewModuleTreeCmd creates the module tree command.
func NewModuleTreeCmd(cfg *config.GlobalConfig) *cobra.Command {
...
Examples:
  ...
  opm module tree --release-id a1b2c3d4-e5f6-7890-abcd-ef1234567890 -n production`,
