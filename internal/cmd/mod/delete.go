...
func NewModDeleteCmd(cfg *cmdtypes.GlobalConfig) *cobra.Command {
...
func runDelete(_ []string, cfg *cmdtypes.GlobalConfig, rsf *cmdutil.ReleaseSelectorFlags, kf *cmdutil.K8sFlags, force, dryRun, _ /* wait */, ignoreNotFound bool) error { //nolint:gocyclo // orchestration function; complexity is inherent
