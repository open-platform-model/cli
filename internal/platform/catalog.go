...
// DefaultCatalogPath is the catalog `opm operator install` seeds a Platform
// with, re-exported here so callers resolving a version and callers building
// a subscription name the same constant.
