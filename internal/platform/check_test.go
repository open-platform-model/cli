...
func TestReportRender(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			absent: []string{"unfulfilled contracts", "over-subscribed contracts", "vacuously"},
		},
		{
			...
			absent: []string{"over-subscribed contracts"},
		},
		{
		...
		},
		{
			...
			absent: []string{"defined contracts:", "unfulfilled contracts", "over-subscribed contracts"},
		},
	}
...
// TestRoutableIsTheOnlyVerdict pins the asymmetry enhancement 0015 D18
...
func TestRoutableIsTheOnlyVerdict(t *testing.T) {
